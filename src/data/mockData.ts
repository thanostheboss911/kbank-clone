...
export const storyMockData = [
  {
    id: 1,
    title: '금리 인하 시대,\n지금 적금 들어도 괜찮을까?',
    subDesc: '케이뱅크 금융 트렌드 리포트',
    imgUrl: 'https://picsum.photos/seed/kbank1/400/640',
  },
  {
    id: 2,
    title: '하루 커피값으로\n시작하는 재테크 습관',
    subDesc: '작은 습관이 만드는 큰 변화',
    imgUrl: 'https://picsum.photos/seed/kbank2/400/640',
  },
  {
    id: 3,
    title: '2025년 달라진\n금융 혜택 총정리',
    subDesc: '놓치면 후회하는 케이뱅크 혜택',
    imgUrl: 'https://picsum.photos/seed/kbank3/400/640',
  },
  {
    id: 4,
    title: '대출 전에 꼭 알아야 할\n신용점수 관리법',
